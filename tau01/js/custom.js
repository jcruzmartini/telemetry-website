...
function template_functions(){
	...
	/* ---------- Custom Slider ---------- */
		...
		$(".sliderMin").slider({
			range: "min", value: 180, min: 1, max: 700,
		...
		$(".sliderMin-1").slider({
			range: "min", value: 50, min: 1, max: 700,
			slide: function( event, ui ) {
		...
		$(".sliderMin-2").slider({
			range: "min", value: 100, min: 1, max: 700,
			slide: function( event, ui ) {
		...
		$(".sliderMin-3").slider({
			range: "min", value: 150, min: 1, max: 700,
			slide: function( event, ui ) {
		...
		$(".sliderMin-4").slider({
			range: "min", value: 250, min: 1, max: 700,
			slide: function( event, ui ) {
		...
		$(".sliderMin-5").slider({
			range: "min", value: 350, min: 1, max: 700,
			slide: function( event, ui ) {
		...
		$(".sliderMin-6").slider({
			range: "min", value: 450, min: 1, max: 700,
			slide: function( event, ui ) {
				$( ".sliderLabel" ).html( "$" + ui.value );
			}
		});
		...
		$(".sliderMin-7").slider({
			range: "min", value: 550, min: 1, max: 700,
			slide: function( event, ui ) {
				$( ".sliderLabel" ).html( "$" + ui.value );
			}
		});
		...
		$(".sliderMin-8").slider({
			range: "min", value: 650, min: 1, max: 700,
			slide: function( event, ui ) {
				$( ".sliderLabel" ).html( "$" + ui.value );
			}
		});
		...
		$(".sliderMax").slider({
			range: "max", value: 280, min: 1, max: 700,
			slide: function( event, ui ) {
		...
		$( ".sliderRange" ).slider({
			range: true, min: 0, max: 500, values: [ 192, 470 ],
			slide: function( event, ui ) {
...
function charts() {
	...
	if($("#activeUsers").length) {
	    ...
	    function plotWithOptions2() {
	        ...
	        $.plot($("#activeUsers"), [ d1 ], {series: {bars: { show: bars, fill: true, barWidth: 0.1,align: "center", lineWidth: 5, fillColor: { colors: [ { opacity: 1 }, { opacity: 0.5 } ] }}},	grid: { hoverable: true, clickable: true, tickColor: "#f6f6f6", borderWidth: 0},
				colors: ["#CBE968"],
	...
	if($("#stackchart").length)
	{
		...
		var stack1 = 0, bars1 = true, lines1 = false, steps1 = false;

		function plotWithOptions() {
			$.plot($("#stackchart"), [ d1, d2, d3 ], {
				series: {
					stack: stack1,
					lines: { show: lines1, fill: true, steps: steps1},
					bars: { show: bars1, barWidth: 0.6 }
				},
				colors: ["#FA5833", "#2FABE9", "#FABB3D"]
			});
		}
